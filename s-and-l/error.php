...
<body>
    <div class="container">
        ...
        <div id="admin-block" class="row justify-content-center">
            <div class="col-md-6 p-5">
                <h3 style="text-align:center;">An error has occured. The system administrator has been notified.</h3>
            </div>
        </div>
...
<footer>
    ...
    <div class="text-center p-4">
        <p> &copy; <?php echo date("Y") . " "; ?>Copyright S &amp; L Home Services</p>
    </div>
</footer>
